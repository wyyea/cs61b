 ...
 * the code.
 *
 * <p>You are free to (and encouraged to) create and add your own tiles to this file. This file will
 * be turned in with the rest of your code.
 *
 * <p>Ex: world[x][y] = Tileset.FLOOR;
 *
 * <p>The style checker may crash when you try to style check this file due to use of unicode
...
public class Tileset implements Serializable {
    ...
    public static final TETile LOCKED_DOOR =
            new TETile('█', Color.orange, Color.black, "locked door");
    public static final TETile UNLOCKED_DOOR =
            new TETile('▢', Color.orange, Color.black, "unlocked door");
